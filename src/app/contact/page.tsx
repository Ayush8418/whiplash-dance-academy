      ...
      <div className='flex flex-wrap justify-evenly gap-10 ' >
        <div className='min-w-[30%] max-w-[45%]'>
          <div className='bg-slate-200 text-black h-fit p-6 mb-6 rounded'>
            ...
            <br />
            <h2 className="text-xl font-semibold">We are Happy to Collaborate</h2>
          ...
          <div className='bg-slate-200 text-black h-fit p-6 mb-6 rounded'>
            ...
            <p className=''>Hi, Im a Full Stack Developer and an enthusiastic learner with a growing passion for Data Structures and Algorithms (DSA). Currently pursuing my B.Tech Final Year, I am actively seeking internship and job opportunities where I can apply my technical skills and creative thinking to real-world challenges.
              ...
              If youre interested in collaborating or have an opportunity where I can contribute and grow, feel free to get in touch — I would love to hear from you!</p>
          </div>
        </div>
